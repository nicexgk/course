		...
		<form class="layui-form" action="">
			<div class="layui-form-item">
			    ...
			    <div class="layui-input-block" >
			    	<input type="text" name="coursename" lay-verify="required" placeholder="请输入课程名称" class="layui-input" style="width:250px;">
			    </div>
			</div>
			<div class="layui-form-item">
			    <label class="layui-form-label">所属类目</label>
			   	<div class="layui-input-block">
			    	<div class="firstselect" >
			    		<select id="select1" lay-filter="myselect" lay-verify="required" name="parenttype" onchange="setSecond()">
			    	...
			    	<div class="firstselect">
		 				<select id="select2" name="coursetype" lay-verify="required" style="width:170px;">
