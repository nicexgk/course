...
<link href="/twitter-bootstrap/twitter-bootstrap-v2/docs/assets/css/bootstrap.css"
	rel="stylesheet">
...
<body>
	<form class="form-inline definewidth m20" action="#" method="get">
		<font color="#33ccff"><strong>公告标题：</strong></font> <input type="text" name="menuname"
	...
	<table class="table table-bordered table-hover definewidth m10">
		...
		<tr>
			<td>人生何处不青山</td>
			<td><a href="#" id="xiangqing" rel="popover" data-original-title="公告标题"
